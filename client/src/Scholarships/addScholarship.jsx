...
function AddScholarship() {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3001/organFind/${email}`)
      .then((res) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("http://localhost:3001/addScholarship", {
        nameofBaiguullaga,
        email,
        nameofTetgeleg,
        hotolbor,
    ...
    <div className="tetgeleg">
      ...
      <fieldset >
        <form onSubmit={handleSubmit}>
          ...
          <br />
          <br />
          <select name="lang1" onChange={(e) => setLan1(e.target.value)}>
